...
const PALETTES = {
  ...
  anime: ['linear-gradient(135deg, #e8a0c8, #f0b8d8)', 'linear-gradient(135deg, #c0a0e0, #d0b0f0)', 'linear-gradient(135deg, #f0a0b0, #f8c0d0)', 'linear-gradient(135deg, #a0c0ff, #b0d8ff)', 'linear-gradient(135deg, #ffa0c0, #ffc0d8)', 'linear-gradient(135deg, #c0e0ff, #d0f0ff)', 'linear-gradient(135deg, #e0a0d0, #f0b8e0)', 'linear-gradient(135deg, #80c0a0, #90d0b0)'],
  retro: ['linear-gradient(135deg, #c89050, #d0a068)', 'linear-gradient(135deg, #8b7355, #a08060)', 'linear-gradient(135deg, #d09060, #e0b080)', 'linear-gradient(135deg, #a07040, #b08858)', 'linear-gradient(135deg, #c8a070, #d8b888)', 'linear-gradient(135deg, #b08050, #c09868)', 'linear-gradient(135deg, #9a7060, #b08878)', 'linear-gradient(135deg, #c0a080, #d0b898)'],
  cyber: ['linear-gradient(135deg, #00c8ff, #0080ff)', 'linear-gradient(135deg, #8000ff, #c000ff)', 'linear-gradient(135deg, #00ffcc, #00e0a0)', 'linear-gradient(135deg, #ff0080, #ff4000)', 'linear-gradient(135deg, #0080ff, #00c8ff)', 'linear-gradient(135deg, #ff00ff, #8000ff)', 'linear-gradient(135deg, #00ff80, #00c0ff)', 'linear-gradient(135deg, #ff8000, #ffcc00)'],
  pastel: ['linear-gradient(135deg, #f0b8c0, #f8d0d8)', 'linear-gradient(135deg, #b8d0f0, #c8e0f8)', 'linear-gradient(135deg, #d0b8f0, #e0c8f8)', 'linear-gradient(135deg, #f8e0c0, #fff0d8)', 'linear-gradient(135deg, #c0f0d0, #d0f8e0)', 'linear-gradient(135deg, #f0c0d8, #f8d8e8)', 'linear-gradient(135deg, #d8f0f0, #e8f8f8)', 'linear-gradient(135deg, #f8d0c0, #ffe0d8)'],
  nord: ['linear-gradient(135deg, #88c0d0, #81a1c1)', 'linear-gradient(135deg, #a3be8c, #b48ead)', 'linear-gradient(135deg, #5e81ac, #81a1c1)', 'linear-gradient(135deg, #bf616a, #d08770)', 'linear-gradient(135deg, #8fbcbb, #88c0d0)', 'linear-gradient(135deg, #b48ead, #a3be8c)', 'linear-gradient(135deg, #d8dee9, #eceff4)', 'linear-gradient(135deg, #4c566a, #5e81ac)'],
  neon: ['linear-gradient(135deg, #ff0080, #ff4000)', 'linear-gradient(135deg, #00ff80, #00c0ff)', 'linear-gradient(135deg, #ff00ff, #00ffff)', 'linear-gradient(135deg, #ffff00, #ff8000)', 'linear-gradient(135deg, #00ff00, #80ff00)', 'linear-gradient(135deg, #8000ff, #ff0080)', 'linear-gradient(135deg, #00c0ff, #0080ff)', 'linear-gradient(135deg, #ff8000, #ffff00)'],
  earth: ['linear-gradient(135deg, #8b7355, #a08060)', 'linear-gradient(135deg, #6b8e5a, #7a9e68)', 'linear-gradient(135deg, #a08050, #b09068)', 'linear-gradient(135deg, #5a7a4a, #6a8a58)', 'linear-gradient(135deg, #9a8060, #aa9070)', 'linear-gradient(135deg, #7a6a50, #8a7a60)', 'linear-gradient(135deg, #6b8e3a, #7b9e4a)', 'linear-gradient(135deg, #8a7060, #9a8070)'],
  candy: ['linear-gradient(135deg, #ffb8d0, #ffc8e0)', 'linear-gradient(135deg, #b8e0ff, #c8f0ff)', 'linear-gradient(135deg, #ffd0a0, #ffe0b8)', 'linear-gradient(135deg, #d0ffb8, #e0ffc8)', 'linear-gradient(135deg, #e0b8ff, #f0c8ff)', 'linear-gradient(135deg, #ffb8b8, #ffc8c8)', 'linear-gradient(135deg, #b8ffb8, #c8ffc8)', 'linear-gradient(135deg, #ffffb8, #ffffd0)'],
}
...
export default {
  ...
  data() {
    return {
      ...
      selectedVideo: null,
      activeTab: 'movies',
      cfg: { baseSize: 16, fillPercent: 50, spacing: 16, colorMode: 'legendary', palette: 'monet', customGradients: [], goldLegend: true },
      bubbleRects: new Map(),
      categoryStats: {},
      rarityMap: {},
    }
  ...
  methods: {
    ...
    bubbleStyle(tag) {
      ...
      const style = {
        // background controlled by CSS class in legendary mode
    ...
    computeRarity(stats) {
      ...
      sorted.forEach((cat, i) => {
        ...
        if (pct < 0.05)       rarityMap[cat.id] = 'legendary'
        else if (pct < 0.20) rarityMap[cat.id] = 'epic'
        else if (pct < 0.50) rarityMap[cat.id] = 'rare'
        else                  rarityMap[cat.id] = 'common'
      })
